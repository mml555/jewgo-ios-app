...
BEGIN
    ...
    -- Insert diverse sample jobs with realistic variety
    INSERT INTO jobs (
    ...
    -- Job 2: Assistant Principal (Different from the repetitive one in image)
    (
        'Assistant Principal',
        'Lead academic excellence at our growing Jewish day school. Support the principal in curriculum development, teacher mentoring, and student discipline. Ideal for experienced educators ready for leadership roles in Jewish education.',
        'Beth Jacob Academy',
        school_user_id,
        'on-site',
        FALSE,
        ...
        'full-time',
        'Education',
        ARRAY['full-time', 'education', 'leadership'],
        ARRAY['Master''s degree in Education Administration', '5+ years teaching experience', 'Leadership experience'],
        ARRAY['Administrative certification', 'Experience in Jewish education', 'Strong communication skills'],
        'senior',
        ARRAY['Health insurance', 'Retirement plan', 'Paid Jewish holidays', 'Professional development'],
        'Monday-Thursday 7:30am-4:30pm, Friday 7:30am-2:30pm',
        '2025-09-01'::DATE,
        'hr@bethjacobacademy.org',
        '305-555-0201',
        TRUE,
        TRUE,
        TRUE,
    ...
    -- Job 3: Warehouse Manager (Different from repetitive one)
    (
        'Warehouse Manager',
        'Oversee operations at our kosher food distribution center. Manage inventory, coordinate deliveries, and ensure compliance with kashrut standards. Great opportunity for someone with logistics experience in the Jewish food industry.',
        'Kosher Distribution Plus',
        test_user_id,
        'on-site',
        FALSE,
        'Miami',
        ...
        'full-time',
        'Logistics',
        ARRAY['full-time', 'logistics', 'management'],
        ARRAY['3+ years warehouse management', 'Forklift certification', 'Inventory management experience'],
        ARRAY['Knowledge of kosher standards', 'Leadership skills', 'Computer proficiency'],
        'mid',
        ARRAY['Health insurance', 'Paid time off', 'Overtime available', 'Employee discount'],
        'Monday-Friday 6am-2pm, some weekends',
        '2025-10-01'::DATE,
        'jobs@kosherdist.com',
        '305-555-0301',
        TRUE,
    ...
    -- Job 4: Call Center Agent (Different from repetitive one)
    (
        'Customer Service Representative',
        'Join our team at a leading kosher food company. Handle customer inquiries, process orders, and provide excellent service to our Jewish community customers. Training provided, great entry-level opportunity.',
        'Kosher Foods International',
        test_user_id,
        'remote',
        TRUE,
        NULL,
        ...
        'full-time',
        'Customer Service',
        ARRAY['full-time', 'remote', 'customer-service'],
        ARRAY['High school diploma', 'Strong communication skills', 'Computer proficiency'],
        ARRAY['Customer service experience', 'Bilingual (English/Hebrew)', 'Sales experience'],
        'entry',
        ARRAY['Health insurance', 'Remote work', 'Paid training', 'Career advancement'],
        'Monday-Friday 9am-5pm EST',
        '2025-11-01'::DATE,
        'careers@kosherfoods.com',
        NULL,
        FALSE,
        FALSE,
        TRUE,
    ...
    -- Job 5: Web Designer (Different from repetitive one)
    (
        'Web Designer',
        'Create beautiful, user-friendly websites for Jewish organizations and businesses. Work on diverse projects including synagogue websites, kosher restaurant sites, and educational platforms. Remote-friendly position.',
        'Digital Torah Solutions',
        test_user_id,
        'hybrid',
        FALSE,
        'Miami',
        ...
        'contract',
        'Technology',
        ARRAY['contract', 'hybrid', 'web-design'],
        ARRAY['Portfolio of web design work', 'Proficiency in HTML/CSS/JavaScript', 'Experience with WordPress'],
        ARRAY['UI/UX design skills', 'Knowledge of Jewish web standards', 'SEO experience'],
        'mid',
        ARRAY['Flexible schedule', 'Remote work options', 'Creative projects', 'Competitive rates'],
        'Flexible 20-40 hours/week',
        '2025-10-15'::DATE,
        'design@digitaltorah.com',
        '305-555-0401',
        FALSE,
        TRUE,
        TRUE,
    ...
    -- Job 7: Marketing Coordinator
    (
        'Marketing Coordinator',
        'Join our dynamic marketing team at a growing Jewish nonprofit. Develop campaigns, manage social media, create content, and help spread awareness of our community programs. Perfect for creative individuals passionate about Jewish community engagement.',
        ...
        'full-time',
        'Marketing',
        ARRAY['full-time', 'marketing', 'nonprofit'],
        ARRAY['Bachelor''s degree in Marketing or related field', 'Social media experience', 'Strong writing skills'],
        ARRAY['Graphic design skills', 'Event planning', 'Jewish community knowledge'],
        'entry',
        ARRAY['Health insurance', 'Paid time off', 'Professional development', 'Community impact'],
    ...
    (
        'Staff Accountant',
        'Join our finance team at a respected Jewish organization. Handle accounts payable/receivable, prepare financial reports, and assist with budgeting. Great opportunity for detail-oriented professionals who want to contribute to meaningful community work.',
        'Jewish Federation',
        test_user_id,
        'hybrid',
        FALSE,
        ...
        'full-time',
        'Finance',
        ARRAY['full-time', 'hybrid', 'accounting'],
        ARRAY['Bachelor''s degree in Accounting', '2+ years accounting experience', 'Proficiency in QuickBooks'],
        ARRAY['CPA preferred', 'Nonprofit experience', 'Excel expertise'],
        'mid',
        ARRAY['Health insurance', '401k matching', 'Flexible schedule', 'Paid holidays'],
        'Monday-Friday 8am-5pm, 3 days remote',
        '2025-10-20'::DATE,
        'hr@jewishfederation.org',
        '312-555-0601',
        FALSE,
        TRUE,
        TRUE,
    ...
    -- Job 9: Event Coordinator
    (
        'Event Coordinator',
        'Plan and execute memorable events for our synagogue community. Coordinate Shabbat dinners, holiday celebrations, and social gatherings. Work with volunteers and vendors to create meaningful experiences that bring our community together.',
        'Temple Beth El',
        community_user_id,
        'on-site',
        FALSE,
        ...
        'part-time',
        'Event Planning',
        ARRAY['part-time', 'events', 'community'],
        ARRAY['Event planning experience', 'Strong organizational skills', 'Excellent communication'],
        ARRAY['Catering knowledge', 'Volunteer management', 'Jewish holiday expertise'],
        'entry',
        ARRAY['Flexible hours', 'Meaningful work', 'Networking opportunities', 'Event perks'],
        'Part-time, evenings and weekends',
        '2025-10-01'::DATE,
        'events@templebethel.org',
        '617-555-0701',
        TRUE,
        TRUE,
        TRUE,
    ...
    -- Job 10: IT Support Specialist
    (
        'IT Support Specialist',
        'Provide technical support for our Jewish day school''s technology infrastructure. Maintain computers, networks, and educational software. Help teachers and staff with technology needs. Great role for tech-savvy individuals who enjoy helping others.',
        ...
        'full-time',
        'Technology',
        ARRAY['full-time', 'it-support', 'education'],
        ARRAY['Associate degree in IT or equivalent experience', 'Windows/Mac troubleshooting', 'Network basics'],
        ARRAY['Educational technology experience', 'Help desk experience', 'Customer service skills'],
        'mid',
        ARRAY['Health insurance', 'Paid time off', 'Summer schedule', 'Professional development'],
