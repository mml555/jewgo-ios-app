-- Migration: Transform to Enhanced Schema
-- Date: 2025-01-19
...
UPDATE entities SET location = ST_SetSRID(ST_MakePoint(longitude, latitude), 4326)::geography
...
-- =============================================================================
-- STEP 5: CLEAN UP OLD COLUMNS (COMMENTED OUT FOR SAFETY)
-- =============================================================================

-- Uncomment these lines after verifying data migration is successful
-- ALTER TABLE entities DROP COLUMN entity_type;
-- ALTER TABLE entities DROP COLUMN kosher_level;
-- ALTER TABLE entities DROP COLUMN denomination;
-- ALTER TABLE entities DROP COLUMN store_type;
-- ALTER TABLE entities DROP COLUMN services;
-- ALTER TABLE entities DROP COLUMN facebook_url;
-- ALTER TABLE entities DROP COLUMN instagram_url;
-- ALTER TABLE entities DROP COLUMN twitter_url;
-- ALTER TABLE entities DROP COLUMN whatsapp_url;
-- ALTER TABLE entities DROP COLUMN tiktok_url;
-- ALTER TABLE entities DROP COLUMN youtube_url;
-- ALTER TABLE entities DROP COLUMN snapchat_url;
-- ALTER TABLE entities DROP COLUMN linkedin_url;
-- ALTER TABLE entities DROP COLUMN latitude;
-- ALTER TABLE entities DROP COLUMN longitude;
-- ALTER TABLE business_hours DROP COLUMN day_of_week;

-- =============================================================================
-- STEP 6: ADD ENHANCED FUNCTIONS AND TRIGGERS
-- =============================================================================
