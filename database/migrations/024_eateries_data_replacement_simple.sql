-- Migration: Eateries Data Replacement (Simplified)
-- Date: 2025-01-19
-- Description: Update kosher_level values to dietary types, standardize kosher_certification, add price_min/max
...
-- Step 2: Update kosher_level values to dietary types
-- For entities table
UPDATE entities 
...
-- Step 3: Standardize kosher_certification values
...
-- Step 4: Add price_min and price_max fields
