-- Migration: Eateries Data Enhancement (Simple)
-- Date: 2025-01-19
-- Description: Add price_min/max columns and standardize kosher_certification
...
-- Step 2: Add price_min and price_max fields
...
-- Step 3: Migrate price_range to min/max using the 11 price brackets
...
-- Step 4: Update price_range to use the 11 specific brackets
UPDATE restaurants_normalized
SET price_range = CASE
  WHEN price_min >= 5 AND price_max <= 10 THEN '$5-10'
  WHEN price_min >= 10 AND price_max <= 20 THEN '$10-20'
  WHEN price_min >= 20 AND price_max <= 30 THEN '$20-30'
  WHEN price_min >= 30 AND price_max <= 40 THEN '$30-40'
  WHEN price_min >= 40 AND price_max <= 50 THEN '$40-50'
  WHEN price_min >= 50 AND price_max <= 60 THEN '$50-60'
  WHEN price_min >= 60 AND price_max <= 70 THEN '$60-70'
  WHEN price_min >= 70 AND price_max <= 80 THEN '$70-80'
  WHEN price_min >= 80 AND price_max <= 90 THEN '$80-90'
  WHEN price_min >= 90 AND price_max <= 100 THEN '$90-100'
  WHEN price_min >= 100 THEN '$100+'
  ELSE '$10-20'
END
WHERE price_min IS NOT NULL AND price_max IS NOT NULL;

-- Step 5: Standardize kosher_certification values
