...
async function convertSvgToPng() {
  ...
  try {
    ...
    console.log(
      '1. Upload jewgo-icon-1024.png to https://appicon.co for iOS icons',
    );
    console.log(
      '2. Upload jewgo-icon-1024.png to https://romannurik.github.io/AndroidAssetStudio for Android icons',
    );
