...
const BasicInfoPage: React.FC<BasicInfoPageProps> = memo(
  ({ formData, onFormDataChange }) => {
    ...
    const validateField = (field: keyof ListingFormData, value: any) => {
      switch (field) {
        case 'name':
    ...
    const handleAddressVerified = useCallback((addressDetails: any) => {
      debugLog('✅ Address verified:', addressDetails);
    ...
    const validateForm = useCallback(() => {
      ...
      if (!formData.business_email.trim()) {
        ...
        !/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(formData.business_email.trim())
      ) {
              ...
              <View
                style={[
                  styles.inputHalf,
                  {
                    ...
                    marginBottom: dimensions.isSmallScreen
                      ? responsiveLayout.formSpacing
                      : 0,
                  },
                ]}
              >
                  ...
                  <TouchableOpacity
                    ...
                    style={[
                      ...
                      formData.listing_type === type.value &&
                        styles.listingTypeOptionSelected,
                    ]}
                    onPress={() => handleListingTypeSelect(type.value)}
                    activeOpacity={0.7}
                    accessibilityRole="radio"
                    accessibilityState={{
                      selected: formData.listing_type === type.value,
                    }}
                  ...
                  >
                    ...
                    <Text
                      style={[
                        ...
                        {
                          fontSize: dimensions.isSmallScreen
                            ? Typography.fontSize.sm * 0.9
                            : Typography.fontSize.sm,
                        },
                        formData.listing_type === type.value &&
                          styles.listingTypeLabelSelected,
                      ]}
                    >
                      {type.label}
                    </Text>
                ...
                <Text
                  style={[
                    styles.errorText,
                    {
                      ...
                      marginTop: responsiveLayout.formSpacing,
                    },
                  ]}
                >
                  {errors.listing_type}
          ...
          {formData.is_owner_submission && (
            <View style={styles.section}>
              ...
              <EnhancedFormInput
                ...
                onChangeText={value =>
                  handleInputChange('owner_phone', formatPhoneNumber(value))
                }
                placeholder="(555) 123-4567"
                leftIcon="📞"
                keyboardType="phone-pad"
