...
const BasicInfoPage: React.FC<BasicInfoPageProps> = ({
  ...
  const handleInputChange = useCallback(
    (field: keyof SynagogueFormData, value: string | boolean) => {
  ...
  const validateField = (field: keyof SynagogueFormData, value: any) => {
    switch (field) {
      case 'name':
  ...
  const handleCongregationSizeSelect = useCallback(
    (selectedSize: string) => {
      hapticButtonPress();
        ...
        <View style={styles.form}>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.inputGroup, styles.flex1]}>
              ...
              <TextInput
                style={[styles.textInput, errors.zip_code && styles.inputError]}
          ...
          <View style={styles.inputGroup}>
            ...
            <TextInput
              style={[styles.textInput, errors.rabbi_name && styles.inputError]}
            ...
            />
            {errors.rabbi_name && (
              <Text style={styles.errorText}>{errors.rabbi_name}</Text>
            )}
          </View>
            ...
            <View style={styles.optionGrid}>
              {denominations.map(denomination => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.optionCard,
                    formData.denomination === denomination.value &&
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.optionGrid}>
              {congregationSizes.map(size => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.optionCard,
                    formData.congregation_size === size.value &&
                      styles.optionCardSelected,
                  ]}
            ...
            {errors.congregation_size && (
              <Text style={styles.errorText}>{errors.congregation_size}</Text>
            )}
          </View>
        </View>
      </ScrollView>
