...
const DayHoursRow: React.FC<DayHoursRowProps> = memo(
  ({
      ...
      if (isScreenReaderEnabled) {
        ...
        announceForScreenReader(
          `${day} next day mode ${
            ...
            newState ? 'closes after midnight' : 'closes same day'
          }.`,
          'polite',
        );
      }
    ...
    const handleCopyPress = useStableCallback(() => {
      if (onCopyHours) {
        ...
        if (isScreenReaderEnabled) {
          ...
          announceForScreenReader(`Copying hours from ${hoursLabel}`, 'polite');
        }
      }
    }, [
      onCopyHours,
    ...
    const dayRowLabel = generateBusinessHoursLabel(
      day,
      isOpen,
      openTime,
      closeTime,
      ...
      >
        ...
        >
          <View style={styles.dayLabelContainer}>
            ...
            <Text style={styles.dayFullName} accessibilityRole="text">
              {day}
            </Text>
          </View>
          ...
          >
            ...
            <TouchableOpacity
              ...
              activeOpacity={0.7}
              accessibilityLabel={`${day} is currently ${
                isOpen ? 'open' : 'closed'
              }`}
              accessibilityHint={generateAccessibilityHint(
                `${isOpen ? 'close' : 'open'} ${day}`,
                isOpen
                  ? 'This will hide the time pickers'
                  : 'This will show the time pickers',
              )}
            ...
            <View style={styles.controlsRow}>
              <TouchableOpacity
                style={[
                  ...
                  isNextDay && styles.nextDayButtonActive,
                ]}
              ...
              >
                <Text
                  style={[
                    styles.nextDayText,
                    isNextDay && styles.nextDayTextActive,
                  ]}
                  accessibilityRole="text"
                >
                  Next Day
                ...
                <Text
                  style={[
                    styles.nextDaySubtext,
                    isNextDay && styles.nextDaySubtextActive,
                  ]}
                  accessibilityRole="text"
                >
              ...
              {showCopyButton && onCopyHours && (
                <TouchableOpacity
                  style={[
                    styles.copyButton,
                    loading && styles.copyButtonDisabled,
                  ]}
                  ...
                  accessibilityHint={generateAccessibilityHint(
                    ...
                    `Current hours: ${openTime} to ${closeTime}${
                      isNextDay ? ' next day' : ''
                    }`,
                  )}
                ...
                >
                  ...
                  <Text style={styles.copyButtonLabel} accessibilityRole="text">
                    Copy
                  </Text>
                </TouchableOpacity>
              )}
