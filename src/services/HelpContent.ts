...
class HelpContentService {
  ...
  getFieldHelp(fieldName: string): HelpContent | null {
    const helpContent: Record<string, HelpContent> = {
      business_name: {
        title: 'Business Name',
        description: 'Enter your official business name as it appears on your signage and legal documents.',
        tips: [
      ...
      address: {
        ...
        description: 'Provide your complete business address including street number, street name, city, state, and zip code.',
        tips: [
      ...
      phone: {
        ...
        description: 'Enter your main business phone number that customers can call during business hours.',
        tips: [
      ...
      business_email: {
        ...
        description: 'Provide your business email address for customer inquiries and important communications.',
        tips: [
      ...
      kosher_category: {
        ...
        description: 'Select the primary kosher category that best describes your restaurant.',
        tips: [
      ...
      certifying_agency: {
        ...
        description: 'Select the organization that provides your kosher certification.',
        tips: [
      ...
      business_hours: {
        ...
        description: 'Set your operating hours for each day of the week. Customers rely on this information to know when you\'re open.',
        tips: [
      ...
      short_description: {
        ...
        description: 'Write a brief, engaging description of your restaurant in 1-2 sentences.',
        tips: [
      ...
      description: {
        ...
        description: 'Provide a comprehensive description of your restaurant, including atmosphere, specialties, and what customers can expect.',
        tips: [
      ...
      catering_available: {
        ...
        description: 'Indicate whether you provide catering for events and parties.',
        tips: [
      ...
      business_images: {
        ...
        description: 'Upload high-quality photos that showcase your restaurant, food, and atmosphere.',
        tips: [
  ...
  getStepHelp(stepNumber: number): HelpContent | null {
    const stepHelp: Record<number, HelpContent> = {
      1: {
        ...
        description: 'Provide essential business details that customers need to find and contact you.',
        tips: [
      ...
      2: {
        ...
        description: 'Specify your kosher status and certification details to help customers find restaurants that meet their dietary requirements.',
        tips: [
      ...
      3: {
        ...
        description: 'Set your operating schedule and describe your restaurant to help customers know what to expect.',
        tips: [
      ...
      4: {
        title: 'Photos',
        description: 'Upload appealing photos that showcase your restaurant and food to attract customers.',
        tips: [
      ...
      5: {
        title: 'Review & Submit',
        description: 'Review all your information for accuracy before submitting your listing.',
        tips: [
    ...
    const validationHelp: Record<string, Record<string, HelpContent>> = {
      ...
      business_hours: {
        no_days_open: {
          ...
          description: 'Your restaurant must be open at least one day per week.',
          tips: ['Toggle at least one day to "Open"', 'Set opening and closing times']
        },
        invalid_times: {
  ...
  getProgressiveHelp(fieldName: string, interactionCount: number): HelpContent | null {
  ...
  searchHelp(query: string): HelpContent[] {
    const allHelp = [
      ...Object.keys(this.getFieldHelp('')).map(field => this.getFieldHelp(field)!),
      ...Object.keys(this.getStepHelp(0)).map(step => this.getStepHelp(parseInt(step))!)
    ].filter(Boolean);
